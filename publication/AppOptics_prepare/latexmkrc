## Sometimes when the references is very near the end of a page/column, latexmk fails to recognise when bibtex needs to be run. This rule forces bibtex to be run everytime.
