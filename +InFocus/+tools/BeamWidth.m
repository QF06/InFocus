...
%%  BeamWidth calculate the full width of the two independent variables whose corresonding 
...
%% Description
% 1/e^2 width of the waveform y(x) and its polarity.
% The BeamWidth result in 'width' will be in units of 'x'
%% Copyright
